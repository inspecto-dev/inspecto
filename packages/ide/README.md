...
- **Broad IDE Support**: Works seamlessly across **VS Code**, **Cursor**, **Trae**, and **Trae CN**.
...
1. **Install the Extension**: Install the `inspecto` extension in your preferred IDE (VS Code, Cursor, Trae, or Trae CN).
