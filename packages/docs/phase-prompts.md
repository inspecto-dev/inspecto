...
> **`isAction`** is reserved for built-in intents (e.g. `open-in-editor`). Defining it on custom intents has no effect and will log a warning.
...
| `open-in-editor` | Open in Editor       | Always pinned to the bottom |
...
[
  { "id": "explain", "appendPrompt": "Please reply in Chinese." },
  { "id": "fix-bug", "appendPrompt": "Please reply in Chinese." },
  { "id": "fix-styles", "appendPrompt": "Please reply in Chinese." },
  { "id": "refactor", "appendPrompt": "Please reply in Chinese." },
  { "id": "code-review", "appendPrompt": "Please reply in Chinese." },
  { "id": "generate-test", "appendPrompt": "Please reply in Chinese." },
]
```
...
[{ "id": "fix-bug", "appendPrompt": "Minimize changes — preserve the existing code style." }]
```
