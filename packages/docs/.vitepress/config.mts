        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Codex', link: '/zh/integrations/codex-skill' },
              { text: 'Claude Code', link: '/zh/integrations/claude-code-skill' },
              { text: 'Coco', link: '/zh/integrations/coco-skill' },
              { text: 'Copilot', link: '/zh/integrations/copilot-skill' },
              { text: 'Cursor', link: '/zh/integrations/cursor-skill' },
              { text: 'Gemini', link: '/zh/integrations/gemini-skill' },
              { text: 'Trae', link: '/zh/integrations/trae-skill' },
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Codex', link: '/integrations/codex-skill' },
          { text: 'Claude Code', link: '/integrations/claude-code-skill' },
          { text: 'Coco', link: '/integrations/coco-skill' },
          { text: 'Copilot', link: '/integrations/copilot-skill' },
          { text: 'Cursor', link: '/integrations/cursor-skill' },
          { text: 'Gemini', link: '/integrations/gemini-skill' },
          { text: 'Trae', link: '/integrations/trae-skill' },
