...
Unlike `npx @inspecto-dev/cli init` which attempts to install the IDE plugin automatically, when installing manually **you must install the Inspecto companion extension for your editor yourself**. Without this extension, the browser will not be able to send code to your IDE.
