...
- **MCP Server & Tools**: Provide core MCP tools (e.g., `inspecto_watch`, `inspecto_resolve`, `inspecto_reply`) allowing agents to watch for new UI inspections, read context, and reply to developers.
