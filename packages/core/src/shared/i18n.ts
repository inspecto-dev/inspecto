...
const EN_MESSAGES: Record<string, string> = {
  ...
  'launcher.inspectUnavailable.ide-disabled':
    'Inspect is hidden because IDE integration is disabled.',
  'launcher.inspectUnavailable.ide-disconnected': 'Inspect needs an IDE connection in MCP mode.',
  ...
  'menu.copyPrompt': 'Copy prompt',
  'menu.copyPrompt.copied': 'Copied',
  'menu.copyPrompt.defaultAsk': 'Inspect this selected component.',
  ...
  'annotate.composer.shortcut': 'Enter for newline · ⌘/Ctrl+Enter to save',
  ...
  'annotate.liveStatus.copiedToClipboard': 'Copied prompt to clipboard.',
  ...
  'annotate.latestSession.expandTimeline': 'Show updates',
  'annotate.latestSession.collapseTimeline': 'Hide updates',
  'annotate.timeline.title': 'Updates',
  'annotate.timeline.created': 'Created from annotate mode',
  'annotate.timeline.claimed': 'Agent claimed this session',
  'annotate.timeline.agentMessage': 'Agent: {text}',
  'annotate.timeline.resolved': 'Resolved',
  'annotate.timeline.dismissed': 'Dismissed',
  'annotate.timeline.empty': 'No updates yet.',
...
const ZH_CN_MESSAGES: Record<string, string> = {
  ...
  'launcher.inspectUnavailable.ide-disabled': '已禁用 IDE 集成，因此隐藏检查模式。',
  'launcher.inspectUnavailable.ide-disconnected': 'MCP 模式下检查功能需要连接 IDE。',
  ...
  'menu.copyPrompt': '复制 prompt',
  'menu.copyPrompt.copied': '已复制',
  'menu.copyPrompt.defaultAsk': '检查这个选中的组件。',
  ...
  'annotate.composer.shortcut': 'Enter 换行 · ⌘/Ctrl+Enter 保存',
  ...
  'annotate.liveStatus.copiedToClipboard': '已复制 prompt 到剪贴板。',
  ...
  'annotate.latestSession.expandTimeline': '展开进展',
  'annotate.latestSession.collapseTimeline': '收起进展',
  'annotate.timeline.title': '处理进展',
  'annotate.timeline.created': '已从批注模式创建任务',
  'annotate.timeline.claimed': 'Agent 已领取此任务',
  'annotate.timeline.agentMessage': '助手：{text}',
  'annotate.timeline.resolved': '已完成',
  'annotate.timeline.dismissed': '已忽略',
  'annotate.timeline.empty': '暂无进展。',
