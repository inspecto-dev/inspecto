    ...
    <div className="container">
      ...
      <div className="feature-list">
        ...
        <ul>
          ...
          <li>
            🔧 <strong>Works with</strong> Vite, Webpack, Rspack, Rollup
          </li>
          <li>
      ...
      <h2 className="section-title">Test Cases (React + Rspack Legacy)</h2>

      <div className="grid">
        <FeatureCard
          badge="Rspack Legacy Build"
          title="Ultra-fast Transformation"
          content={`Current count is ${count}. This demo uses a legacy Rspack setup to verify that the unplugin still transforms JSX ASTs via magic-string efficiently without slowing the build down.`}
