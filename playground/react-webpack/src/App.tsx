  ...
  return (
    <main className="demo-shell">
      <section className="hero panel">
        <div>
          <span className="hero-kicker">React + Webpack playground</span>
          <h1>Inspecto verification surface</h1>
          <p className="hero-copy">
            Use this page to validate the current browser workflow on a standard Webpack stack:
            choose <strong>Inspect</strong> for one component, <strong>Annotate</strong> for
            batches, and use <strong>Alt + Click</strong> for quick jump to source.
          </p>
        </div>
      ...
      <section className="section">
        <div className="section-heading">
          <h2>Mode checks</h2>
          <p>
            Use this row to validate the three main entry points without relying on outdated copy.
          </p>
        </div>
        ...
        <div className="case-grid">
          ...
          >
            <button
              ...
              onClick={() => {
                throw new Error('Inspecto Webpack runtime test error')
              }}
            >
          ...
          >
            <div className="style-specimen">
              ...
              <div className="style-stack">
                ...
                <span>Legacy route cleanup still pending</span>
              </div>
              <button className="ghost-button">Open migration</button>
            </div>
          </CaseCard>
