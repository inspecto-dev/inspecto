...
// Initialize the client manually for Esbuild
mountInspector({
...
<div class="container" data-inspecto="src/main.js:10:1">
  <header class="header" data-inspecto="src/main.js:11:3">
    ...
    <p data-inspecto="src/main.js:13:5">Click any page element → instantly send code context to AI (Esbuild)</p>
  </header>
  ...
  <div class="feature-list" data-inspecto="src/main.js:20:3">
    ...
    <ul data-inspecto="src/main.js:22:5">
      ...
      <li data-inspecto="src/main.js:25:7">⚡ <strong>Built with</strong> Vanilla JS and Esbuild</li>
    </ul>
  </div>

  <h2 class="section-title" data-inspecto="src/main.js:29:3">Esbuild Integration</h2>
  ...
  <div class="grid" data-inspecto="src/main.js:31:3">
    <div class="card" data-inspecto="src/main.js:32:5">
      ...
      <h2 data-inspecto="src/main.js:34:7">Fastest Bundler</h2>
