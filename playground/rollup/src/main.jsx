    ...
    >
      ...
      >
        ...
        <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.7, color: '#4b5563' }}>
          ...
          <li>
            <strong>Framework-agnostic overlay</strong>：覆盖层基于 Web Component 与 Shadow
            DOM，不会污染应用样式。
          </li>
        </ul>
      </div>
      ...
      >
        ...
        <p style={{ color: '#4b5563', lineHeight: 1.6 }}>
          This React + Rollup example keeps the page lightweight so you can verify that Inspecto
          mounts correctly and inspects elements produced by a Rollup bundle.
        </p>
        <button
          style={{
            padding: '8px 16px',
