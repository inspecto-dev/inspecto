  ...
  return (
    <main className="demo-shell">
      <section className="hero panel">
        <div>
          <span className="hero-kicker">React + Rsbuild / Rspack playground</span>
          <h1>Inspecto verification surface</h1>
          <p className="hero-copy">
            This page verifies the real browser workflow on a fast SWC-based stack: choose{' '}
      ...
      <section className="section">
        <div className="section-heading">
          <h2>Mode checks</h2>
          <p>
            Use this row to validate the three main entry points without relying on old
        ...
        <div className="case-grid">
          ...
          >
            <button
              ...
              onClick={() => {
                throw new Error('Inspecto Rspack runtime test error')
              }}
            >
          ...
          >
            <div className="style-specimen">
              ...
              <div className="style-stack">
                ...
                <span>Build verification is in progress</span>
              </div>
              <button className="ghost-button">Open release</button>
            </div>
          </CaseCard>
