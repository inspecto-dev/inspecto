...
- **[Settings Configuration Guide](./phase-settings.md)**: Contains all field explanations for `settings.json`, IDE scenario configuration examples, global toggles, and CLI/Plugin tool fallback rules.
