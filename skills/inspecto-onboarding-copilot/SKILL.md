...
description: Help users install, configure, or diagnose Inspecto in the current repository. Use this skill when asked to set up Inspecto.
---

# Inspecto Onboarding

When the user asks GitHub Copilot to set up Inspecto:
